...
const FirstLanding = () => {
    ...
    return (
        <div className={classes.root} style={{ padding: '40px', minHeight:'520px' }}>
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={7}>
                    <div className={classes.root} style={{ paddingTop: '10%' }}>
                        ...
                        <Button variant="contained" size="medium" color="primary" className={classes.margin} href="/register" style={{ backgroundColor:'#E3495A' }}>
                            Get Started
                        </Button>
                    </div>
                </Grid>
